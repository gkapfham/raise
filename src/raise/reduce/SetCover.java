...
public class SetCover implements Cloneable, Serializable
{
    ...
    /**
	 * This is for Serializable.  The number was generated by eclipse.
	 */
	private static final long serialVersionUID = -3377152296152272011L;
    ...
    private LinkedHashSet<RequirementSubset> requirementSubsetUniverse;
	...
	-- S -- */
    private LinkedHashSet<SingleTestSubset> testSubsets;
    ...
    private LinkedHashSet<SingleTestSubset> reducedSingleTestSubsets;
	...
	private LinkedHashSet<SingleTest> coverPickSets;
	
	/** The results of reduction */
	private LinkedHashSet<SingleTest> prioritizedSets;
	...
	requirementSubsetUniverse = new LinkedHashSet<RequirementSubset>();
	testSubsets = new LinkedHashSet<SingleTestSubset>();
	reducedSingleTestSubsets = new LinkedHashSet<SingleTestSubset>();
    ...
    // Get the coverPickSets 
  	public LinkedHashSet<SingleTest> getCoverPickSets() 
  	{
	...
	public LinkedHashSet<SingleTest> getPrioritizedSets() 
    {
	...
	public int[] getPrioritizedOrderArray()
	{
		...
		Iterator<SingleTest> stIt = prioritizedSets.iterator();
   ...
   /**
	 ...
	 */
	 ...
	 {
	 	Iterator<SingleTest> testIterator = tests.iterator();
	 	
	 	LinkedHashSet<RequirementSubset> requirements = new LinkedHashSet<RequirementSubset>();
	 	...
	 	while(testIterator.hasNext())
	 	{
	 		...
	 		Iterator<RequirementSubset> coveredRequirementsIterator = 
		...
		// ArrayList<SingleTestSubset> singleTestSubsets = new ArrayList<SingleTestSubset>();
		 ...
		 while(timeScanner.hasNextInt())
		 {
			 ...
			 { 
				 ...
				 // SingleTestSubset
			 	 RequirementSubset req = null; 
				 Iterator<RequirementSubset> existingReqIt = cover.getRequirementSubsetUniverse().iterator();
			 	 while(existingReqIt.hasNext())
			 	 {
			 		 RequirementSubset currentReq = existingReqIt.next();
			 		 if(covReq == currentReq.getIndex())
			 		 {
			 			 req = currentReq;
			 			 break;
			 		 }
				 ...
				 if(req == null)
					 req = new RequirementSubset("RequirementSubset"+covReq, covReq);
				 
				 currentSTS.addRequirementSubset(req);
			 
				 // Add the RS to the SC if it isn't there already.
				 boolean there = false;
				 Iterator<RequirementSubset> SCI = cover.getRequirementSubsetUniverse().iterator();
...
// 	System.out.println("ok,here -- " + testTimingsMap);
     ...
     *  @author Gregory M. Kapfhammer 9/17/2005
     */
    public LinkedHashSet<RequirementSubset> getRequirementSubsetUniverse()
    {
     ...
     */
    public void setRequirementSubsetUniverse(LinkedHashSet<RequirementSubset> universe)
    {
     ...
     *  @author Gregory M. Kapfhammer 9/20/2005
     */
   public void addToRequirementSubsetUniverse(Set<RequirementSubset> moreToUniverse)
    {
  ...
  */
	...
	public void prioritizeUsingGreedy(String metric) 
	{
		...
		//	System.out.println(this.coversRequirementSubsetUniverse(this.getTestSubsets()));
			//System.out.println("TEST SUBSETS:  "+this.getTestSubsets() + "\nREQUIREMENT SUBSETS: "+ this.getRequirementSubsetUniverse());
